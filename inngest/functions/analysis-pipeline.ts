...
Required JSON structure (fill every field — do NOT omit any):
{
  ...
  "investmentMemo": "A comprehensive investor-grade memo in markdown. Use this EXACT 10-section structure:\n\n# Executive Summary\n2-3 sentence investment thesis stating the company, sector, stage, return potential, and a clear verdict (STRONG BUY / BUY / HOLD / PASS). Summarise why this opportunity is compelling right now.\n\n## Deal at a Glance\n- **Company:** [name] | [industry] | [stage] | [geography]\n- **Investment Signal:** [score]/100  |  **Confidence:** [confidence]%\n- **Verdict:** [verdict label]\n- **Return Potential:** [expected return multiple and timeline]\n\n# Market Opportunity\n2 paragraphs covering TAM, SAM, SOM with specific size estimates; annual market growth rate; why-now tailwinds; key industry trends; customer demographics and regulatory dynamics that create or constrain the opportunity.\n\n# Business Overview\n2 paragraphs on the problem solved, product or service description, value proposition, business model and pricing, customer acquisition strategy, product-market fit evidence, and near-term product roadmap.\n\n# Financial Analysis\n1-2 paragraphs on current financial profile: ARR or revenue, burn rate, runway, gross margin, LTV/CAC ratio, and any notable milestones. Where data is undisclosed, note it and infer from stage benchmarks. Comment on financial health and capital efficiency.\n\n# Competitive Analysis\n2 paragraphs on the competitive landscape: 3-5 named competitors, their positioning, and this startup's differentiation. Include the competitive moat (IP, data, network effects, brand) and differentiation score. Explain why the startup can win market share.\n\n# Management Team\n1-2 paragraphs profiling the founding team and key executives: domain expertise, relevant prior experience, team completeness (technical, sales, ops), and founder-market fit. Note any gaps and whether the team can execute the plan.\n\n# Investment Thesis\n2-3 clear sentences on WHY this is an attractive investment right now — specific growth catalysts, timing advantages, strategic fit for a VC portfolio, and what must be true for the investment to succeed.\n\n# Risks and Mitigation\nList 4-6 key risks with mitigation strategy for each (use this exact format):\n- **[Risk Title]:** [1-2 sentence description of the risk and its potential impact] — *Mitigation: [specific mitigation strategy]*\n\n# Valuation and Deal Structure\n1 paragraph covering current valuation or expected range, recommended investment size, implied equity stake, funding stage context, any notable co-investors, and key deal terms to negotiate (liquidation preference, pro-rata rights, board seat).\n\n# Exit Strategies\nList 2-4 exit paths with estimated timelines (use this format):\n- **[Exit type, e.g. Strategic Acquisition]:** [Named potential acquirers or scenario description] — *Timeline: [estimate]*",
  "investmentSignal": 75,
  "confidence": 80,
  "suggestedPrompts": [
